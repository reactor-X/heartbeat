...
var authentication=require('../universe/authentication');
var session_config = require('../../config/app_container').config.session;
var primary_json_generator=require('../os/JSONGenerators/bootstrap');
